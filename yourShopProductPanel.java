 ...
 */
public class yourShopProductPanel extends JPanel {
...
//  JPanel proPanel = new JPanel(new GridBagLayout());;
  ...
  public yourShopProductPanel(int productID )
  {
...
//    priceLabel.setBorder(BorderFactory.createLineBorder(Color.black, 1));
  ...
  public void createImagePanel()
  {
    ...
    try{ 
//      System.out.println(ProductContainer.productList.get(productID).getProductImages().get(0) + "aaa");
...
//      System.out.println(ProductContainer.productList.get(productID).getName());
      ...
      JFrame frame = new deleteItemFrame( productID );
